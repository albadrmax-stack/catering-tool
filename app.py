...
with st.container():
    ...
    # الترتيب الدقيق للإكسل مع إضافة البيان الاصلي في مكانه الصحيح
    excel_cols = [
        '#', 'اسم الصنف', 'التصنيف', 'رمز المادة', 'سعر المادة (ر.س)', 
        'الوحدة الكبيرة', 'الوحدة الصغيرة', 'وزن الوحدة الصغيرة (كجم)', 
        'معامل التحويل', 'البيان الاصلي', 'اسم الشركة / المورد', 'الرقم الضريبي', 
...
if submit and (files_input or (selection == "رابط درايف المباشر" and d_url)):
    ...
    if final_files:
        with st.spinner("جاري تحليل البيانات واستخراج البيان الأصلي لكل صنف..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    قواعد هامة:
                    1. 'البيان الاصلي': قم بدمج محتوى السطر الأصلي للصنف من الفاتورة بنفس ترتيب الأعمدة المكتوب في الفاتورة تماماً، وافصل بين كل عمود وعمود بعلامة شرطة ( - ). مثال: "رقم الصنف : 00098 - المادة : ورق عنب - الوحدة : كرتون - الكمية : 50".
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ اكتمل الاستخراج بنجاح! تم التقاط 'البيان الأصلي' وترتيب الأعمدة بدقة.")
