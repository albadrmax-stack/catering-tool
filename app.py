...
if submit and (files_input or (selection == "رابط درايف المباشر" and d_url)):
    ...
    if final_files:
        with st.spinner("جاري تحليل البيانات وفق القواعد الصارمة للعبوات والتصنيف..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    2. تحليل التعبئة من البيان (مثال "بديل ليمون 12*1 لتر"):
                       - 'الكمية بالوحدة الكبيرة': الرقم الأول في التعبئة (مثال: 12).
                       - 'الكمية بالوحدة الصغيرة': الرقم الثاني في التعبئة (مثال: 1).
                       - 'وحدة الوزن الصغيرة': وحدة القياس المكتوبة (مثال: لتر، جرام، كيلو).
                       - 'الوحدة الصغيرة': **الأصل في العبوات هو "علبة" (للأشياء الجامدة)، وللسوائل "جالون"، إلا إذا نَص البيان الأصلي على شيء مختلف صراحة.** (لا تستخدم كيس أو زجاجة من خيالك. ورق العنب والباذنجان = علبة. بديل الليمون = جالون).
                    ...
                    5. 'التصنيف الذكي': **يجب أن يكون كلمة واحدة فقط لا غير** (مثال: معلبات، صوصات، بهارات، زيوت، خدمات). يُمنع منعاً باتاً كتابة كلمتين مثل "أغذية معلبة".
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ اكتمل الاستخراج! تم تطبيق قواعد العبوات والتصنيف بنجاح.")
