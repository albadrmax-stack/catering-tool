...
if submit and (files_input or (selection == "رابط درايف المباشر" and d_url)):
    ...
    if final_files:
        with st.spinner("جاري تفكيك التعبئة والأوزان والكميات بذكاء ودقة..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    قواعد تفكيك البيان الأصلي (هام جداً):
                    ...
                    2. تحليل التعبئة من البيان (مثال "بديل ليمون 12*1 لتر"):
                       ...
                       - 'الوحدة الصغيرة': شكل العبوة الداخلي (مثال: جالون، حبة، علبة).
                    ...
                    3. إذا كان الصنف وزناً كلياً بدون ضرب (مثل "طحينة 15 كيلو"):
                       ...
                       - 'الوحدة الصغيرة': تنكة أو حبة.
                    4. 'الضريبة': مبلغ مالي بالريال لكل صنف.
                    5. 'المادة/اسم المنتج': اسم الصنف نظيف بدون أرقام أو أوزان.
                    """
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ تم تفكيك الأوزان والكميات بنجاح واحترافية!")
