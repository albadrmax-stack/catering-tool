...
if submit and (files_input or (selection == "رابط درايف المباشر" and d_url)):
    ...
    if final_files:
        with st.spinner("جاري استعادة أسماء الأصناف وتجهيز البيانات..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    # تم تبسيط أمر "اسم الصنف" عشان الذكاء الاصطناعي ما يرتعب ويتركه فاضي
                    prompt = f"""
                    ...
                    2. 'اسم الصنف': استخرج اسم المنتج بوضوح (مثال: ورق عنب محشي سوسن). يُمنع منعاً باتاً ترك هذا الحقل فارغاً! يمكنك تجاهل أرقام التعبئة إذا استطعت.
                    ...
                    for item in items:
                        ...
                        # تم حذف كود (Regex) المعقد الخاص باسم الصنف لمنع مسح البيانات
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ تمت الجراحة رقم 3! اسم الصنف عاد لمكانه الطبيعي بأمان.")
