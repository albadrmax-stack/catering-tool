...
st.markdown("""
    ...
    <div class="subtitle-gray">النسخة الاحترافية - تم ضبط المنطق الحسابي للأوزان والكميات</div>
...
if submit and (files_input or (selection == "رابط درايف المباشر" and d_url)):
    ...
    if final_files:
        with st.spinner("جاري استخراج البيانات وضبط العمليات الحسابية للأوزان..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    # برومبت احترافي يركز على استخراج "الوزن/السعة الإجمالية" كمعامل تحويل
                    prompt = f"""
                    ...
                    1. 'الضريبة': استخرج مبلغ الضريبة الفعلي بالريال لكل صنف، وإياك أن تستخرج النسبة المئوية.
                    2. 'التصنيف الذكي': صنف المنتج بكلمة واحدة (مثال: معلبات، بهارات، صوصات، زيوت، خدمات). لا تتركها None.
                    3. 'الوحدة الصغيرة': استخرج وحدة القياس النهائية (كيلو، جرام، لتر، خدمة).
                    4. 'معامل التحويل': هو **إجمالي الوزن أو السعة داخل الكرتون الواحد**. يجب أن تضرب الأرقام الموجودة في البيان:
                       - مثال: "ورق عنب 6*2 كيلو" -> المعامل هو 12 (لأن 6×2=12).
                       - مثال: "باذنجان 6*2500 جرام" -> المعامل هو 15000 (لأن 6×2500=15000).
                       - مثال: "بديل ليمون 12*1 لتر" -> المعامل هو 12.
                       - مثال: "طحينة 15 كيلو" -> المعامل هو 15.
                       - مثال: "أجرة نقل" -> المعامل 1.
                    ...
                    for item in items:
                        ...
                        try:
                            ...
                            item['معامل التحويل'] = factor # يظهر كرقم صافي لسهولة قراءته رياضياً
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ تم الإصلاح والاستخراج بنجاح تام!")
