        ...
        with st.spinner("جاري تحليل البيانات وإجراء المعالجة الدقيقة..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    # تم تغيير المسميات هنا لمنع الخلط مع الكمية المشتراة
                    prompt = f"""
                    ...
                    3. 'عدد الحبات داخل الكرتون': هو الرقم الأول في وصف التعبئة (مثال: في 6*2500 جرام اكتب 6. في 4*1 جالون اكتب 4). وإذا كان الصنف مفرداً (طحينة 15 كيلو) اكتب 1. **إياك أن تضع الكمية المشتراة (مثل 50 أو 20) هنا!**
                    4. 'وزن أو سعة الحبة الواحدة': هو الرقم الثاني في وصف التعبئة (مثال: في 6*2500 جرام اكتب 2500. في 4*1 جالون اكتب 1). وإذا كان مفرداً اكتب الوزن (15).
                    ...
                    6. 'وحدة القياس': استخرج وحدة القياس فقط (مثل: جرام، كيلو، لتر، مل).
                    ...
                    for item in items:
                        ...
                        # ---------- حساب معامل التحويل (الآن يأخذ عدد الحبات بشكل صحيح) ----------
                        try:
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ تمت المعالجة بنجاح! تم فصل التعبئة عن الكمية المشتراة وتصحيح الأوزان ومعامل التحويل.")
