        ...
        with st.spinner("جاري تحليل البيانات وإجراء المعالجة الدقيقة..."):
            try:
                ...
                for f_item in final_files:
                    ...
                    # الأمر الصارم الجديد لإجبار كتابة اسم العمود قبل القيمة في الملاحظات
                    prompt = f"""
                    ...
                    {{
                        ...
                        "الأصناف": [
                            {{
                                ...
                                "الوحدة الكبيرة": "",
                                "الوحدة الصغيرة": "",
                                "الكمية بالوحدة الكبيرة": "",
                                "الكمية بالوحدة الصغيرة": "",
                                "وحدة الوزن الصغيرة": "",
                                "الضريبة": "",
                                "الاجمالي مع الضريبة": ""
                            }}
                    ...
                    1. 'ملاحظات': يجب دمج محتوى السطر الأصلي للصنف بحيث تكتب (اسم العمود في الفاتورة) ثم نقطتين (:) ثم (القيمة)، وتفصل بين كل عمود وعمود بعلامة ( - ). مثال إلزامي: "رقم الصنف : 00098 - بيان الصنف : ورق عنب محشي - الوحدة : كرتون - الكمية : 50". يُمنع منعاً باتاً كتابة القيم مباشرة بدون أسماء الأعمدة.
                    2. 'اسم الصنف': نظف الاسم تماماً! احذف منه أي أرقام، واحذف كلمات التعبئة (مثل: شد، كرتون، حبة، جالون). مثال: "بديل حامض الليمون شد 4*1" يصبح "بديل حامض الليمون" فقط.
                    3. 'الكمية بالوحدة الكبيرة': هو الرقم الأول في عملية الضرب (مثال: في 4*1 اكتب 4. في 6*2500 اكتب 6). وإذا كان وزناً مفرداً اكتب 1.
                    4. 'الكمية بالوحدة الصغيرة': هو الرقم الثاني في عملية الضرب (مثال: في 4*1 اكتب 1. في 6*2500 اكتب 2500).
                    5. 'الوحدة الصغيرة': استخرجها من الفاتورة إذا ذُكرت صراحة (مثل: جالون، حبة، كيس). وإذا لم تُذكر أبداً، اكتب "علبة". **يُمنع كتابة الأوزان هنا**.
                    6. 'وحدة الوزن الصغيرة': استخرج وحدة القياس فقط (مثل: جرام، كيلو، لتر، مل).
                    7. 'التصنيف': كلمة واحدة فقط.
                    8. 'سعر المادة (ر.س)': رقم صافي فقط.
                    """
                    ...
                    for item in items:
                        ...
                        # ---------- حساب الأوزان وتحويل الجرام للكيلو ----------
                        try:
                ...
                if all_extracted_data:
                    ...
                    st.success("✅ تمت المعالجة بنجاح! تم إرجاع العناوين في حقل الملاحظات.")
